...
Im Anschluss werde ich Sie gleich bitten, ein beispielhaftes Plugin zu entwickeln, mit dem der investierte Aufwand mehrerer Studierender eines Projektteams verglichen werden kann. Es geht dabei weniger darum, **dass** Sie die Aufgabe korrekt oder komplett lösen können, sondern **wie** Sie bei der Entwicklung generell vorgehen würden.  
...
Geben Sie mir anschließend bitte kurz bescheid, wenn Sie bereit sind, die Studie zu beginnen.
